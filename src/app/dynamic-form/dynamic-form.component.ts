import { Component, OnInit, ViewEncapsulation, Input, Output, EventEmitter, OnChanges, ViewChild } from '@angular/core';
import { MatDatepicker } from '@angular/material/datepicker';
import { DomSanitizer, SafeResourceUrl } from '@angular/platform-browser';

@Component({
  selector: 'ng-uui-dynamic-form',
  templateUrl: './dynamic-form.component.html',
  styleUrls: ['./dynamic-form.component.css'],
  encapsulation: ViewEncapsulation.Emulated
})
export class DynamicFormComponent implements OnInit, OnChanges {
  @Input('normalformStringify') normalformStringify: any;
  ...
  ngOnChanges(changes) {
    ...
    if (changes.normalformStringify !== undefined) {
      if (changes.normalformStringify.currentValue !== undefined) {
        this.normalform = JSON.parse(changes.normalformStringify.currentValue);
      }
    }
